...
use Picqer\BolRetailerV10\Model\EconomicOperator;
use Picqer\BolRetailerV10\Model\EconomicOperators;
...
class Client extends BaseClient
{
     ...
     * @throws Exception\UnauthorizedException
     */
    public function queryEconomicOperator(string $search, int $page = 1, int $pageSize = 25): EconomicOperators
    {
