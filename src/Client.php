...
class Client extends BaseClient
{
     ...
     * @throws Exception\Exception when something unexpected went wrong.
     */
    public function getEconomicOperator(string $id): Model\EconomicOperator
    {
        $url = "retailer/economic-operator/{$id}";
        $options = [
            'produces' => 'application/vnd.economic-operator.v1+json',
     ...
     * @throws Exception\Exception when something unexpected went wrong.
     */
    public function queryEconomicOperator(?string $name = null, ?int $page = null, ?int $pageSize = null): Model\EconomicOperatorsPage
    {
